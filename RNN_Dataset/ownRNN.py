...
def get_df():
    df_final = pd.read_csv('Final_DataFrames/Scaled_df.csv')
    df_final['ID'] = df_final.Subject + df_final.Repetition
    df_final = df_final.drop(['Subject', 'Repetition','Datetime'], axis=1)
