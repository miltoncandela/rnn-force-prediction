...
# The following code trains a Recurrent Neural Network (RNN) using sequential data
...
seed(test_seed)
test_ids = sample(train_ids, n_test)
seed(valid_seed)
valid_ids = sample(list(set(train_ids) - set(test_ids)), n_valid)
